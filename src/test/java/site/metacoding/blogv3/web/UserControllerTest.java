...
public class UserControllerTest {
    ...
    public void profileImgUpdate_테스트() throws Exception {
        ...
        // given
        File file = new File(
                "C:\\green_workspace\\spring_lab\\Springboot-Blog-V3\\src\\main\\resources\\static\\images\\dog.jpg");

        MockMultipartFile image = new MockMultipartFile("profileImgFile", "dog.jpg", "image/jpeg",
                Files.readAllBytes(file.toPath()));

        // when /s/api/user/profile-img
    ...
    public void passwordReset_테스트() throws Exception {
        ...
        // Mock를 할 때 Mockito 환경이 아니라 Springboot IoC에 Mock가 되어야 한다. @MockBean 사용!
